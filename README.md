...
**The Gap:** Parents want to help but are left in the dark. Students want support but fear
judgment.
---
## 💡 Our Solution: PranAI
...
Working in Demo: UI/UX flows, Parent alert system, Push notifications, Complete navigation,
Simulated AI responses
Production Version: Real GPT-5.4 Mini API, Cloud push notifications (FCM), Real-time database
sync, Scalable backend infrastructure
👥 Team
